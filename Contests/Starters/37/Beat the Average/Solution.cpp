...
//NOTES:-
//The idea is that since we need to maximize the no. of students getting
//marks above avg, we need to assign them marks just above avg marks, i.e. x+1
//So we see that how many people can get marks x+1 among all n students

//Edge case: if avg marks == max marks, no one can get above avg
void solve()
{
    int n, m, x; // n - no of students, m- max marks, x - avg
