...
//INTUITION: Alice's aim is to maximize the results so he will try to minimise the zeros
//Because the more zeros are there, more will Bob get a chance to AND operate and produce even more 0s
//So Alice's aim is to reduce zeros and Bob's aim is to reduce 1s
